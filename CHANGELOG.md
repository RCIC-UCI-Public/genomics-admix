...
## [Unreleased](https://github.com/RCIC-UCI-Public/genomics-admix/compare/2.5...HEAD)

### Commits

- update copyright [`16c47da`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/16c47da62043cb79088467537554420aff1da93d)
- rm fossils [`8f6cdbf`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/8f6cdbf7e8042544821a6fa9c1da5a0147dab1c1)
- bring back rMATS 4.3.0. [`3500d5d`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/3500d5d86a1cae76c70d9b4f24e7457415b1fc24)
- use actual rpm size [`78c5e99`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/78c5e99e21bf8d13c9b86b05504cbc2ae444d2c3)
- update rpmdb for rocky 9.7 [`24692a0`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/24692a084d92d074ebe0e36a0b98e5112079d820)
- add admix expected rpms sizes [`82386c4`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/82386c452a0d7ddbbc27d81b7409d27fe27f05c7)
- ignore build stage directories [`b3a424d`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/b3a424d033f6c75770558a27782d4d13e9ded16c)
- The first statement of the description shdold [`bf0c564`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/bf0c5647628f12ffcddd07e65e552902440cdf5e)
- rm unused canu [`3239989`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/3239989072d5f66f3026087d92654f54699007ee)
- add base set. [`3d450a4`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/3d450a444a4635b530caf7bc3cadb47c2d894070)
- reset to loder versions used to build base sereset to older versions [`dbec19c`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/dbec19c90c6281c714811609307f32e8f4a42818)
- The build needs go which is no longer part of compiled gcc on rocky9. [`14f52a5`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/14f52a5b13a5036555fd9f1430b167304275b030)
- Compile depends  on include  system include file that changed name from [`bc048fb`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/bc048fba9e2b69904717f3a18759c3e3925bd32f)
- add admix name [`7025680`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/702568044ad1715ecc4a2a556e8587da73d063b5)
- rename sets for easier tracking [`90ed7ca`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/90ed7ca42f481a64a427c336366600784cb2648d)
- rm obsolete cdhit, mcl, prank, fasttree [`49a5550`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/49a55506558519d2f33e6a81a0d155a19ebaba1b)

## [2.5](https://github.com/RCIC-UCI-Public/genomics-admix/compare/2.0...2.5) - 2025-01-21

### Commits

- run auto-changelog before tagging [`02710de`](https://github.com/RCIC-UCI-Public/genomics-admix/commit/02710de8d695c7476b196fc4bfb3c2a5f4a0e0f3)
